...
const STRINGS: Record<string, Record<Lang, string>> = {
  ...
  aboutUs: { en: 'About Us', am: 'ስለ እኛ', om: 'Waa’ee Keenya', ti: 'ብዛዕባና' },
  ai: { en: 'AI', am: 'AI', om: 'AI', ti: 'AI' },
  services: { en: 'Services', am: 'አገልግሎቶች', om: 'Tajaajiloota', ti: 'ግልጋሎታት' },
  startupEcosystem: { en: 'Startup Ecosystem', am: 'የስታርትአፕ ሥነ-ምህዳር', om: 'Sirna Ikosisteemii Startup', ti: 'ኢኮሲስተም ስታርታፕ' },
